...
{
    public class ThemiloStar : Sun
    {
        /// <summary>
        /// A list of all stars
        /// </summary>
        public static List<ThemiloStar> Stars;
        ...
        /// </summary>
        public static ThemiloStar Current;
        ...
        /// </summary>
        public ThemiloSunFlare lensFlare;
        ...
        public static void SunBodyFlux(ModularFlightIntegrator flightIntegrator)
        {
            ...
            foreach (ThemiloStar star in Stars.Where(s => s.sun != FlightIntegrator.sunBody))
            {
                // Set Physics
        ...
        /// </summary>
        public static Double Flux(ModularFlightIntegrator fi, ThemiloStar star)
        {
            // Nullchecks
        ...
        /// </summary>
        public static ThemiloStar GetNearest(CelestialBody body)
        {
